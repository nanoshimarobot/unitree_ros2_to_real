...
ros2_unitree_legged_msgs::msg::BmsState state2rosMsg(BmsState &state)
{
...
ros2_unitree_legged_msgs::msg::MotorState state2rosMsg(MotorState &state)
{
...
ros2_unitree_legged_msgs::msg::IMU state2rosMsg(IMU &state)
{
...
ros2_unitree_legged_msgs::msg::Cartesian state2rosMsg(Cartesian &state)
{
...
ros2_unitree_legged_msgs::msg::LowState state2rosMsg(LowState &state, rclcpp::Time timestamp)
{
    ros2_unitree_legged_msgs::msg::LowState ros_msg;

    // Set header with timestamp from tick
...
ros2_unitree_legged_msgs::msg::HighState state2rosMsg(HighState &state)
{
...
BmsCmd rosMsg2Cmd(const ros2_unitree_legged_msgs::msg::BmsCmd &msg)
{
    BmsCmd cmd;
...
MotorCmd rosMsg2Cmd(const ros2_unitree_legged_msgs::msg::MotorCmd &msg)
{
    MotorCmd cmd;
...
HighCmd rosMsg2Cmd(const ros2_unitree_legged_msgs::msg::HighCmd::SharedPtr &msg)
{
    HighCmd cmd;
...
LowCmd rosMsg2Cmd(const ros2_unitree_legged_msgs::msg::LowCmd::SharedPtr &msg)
{
    LowCmd cmd;
